...
class RNN(nn.Module):
    ...
    def forward(
        self, x: Any, state: Optional[torch.Tensor] = None
        ...
        Returns:
            tuple[torch.Tensor, torch.Tensor]: The output tensor after passing through the MLP, and the hidden state of the RNN.
        """
